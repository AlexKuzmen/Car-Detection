...
def main():
    ...
    speed_estimator = SpeedEstimator(fps=args.fps)
    ...
    while True:
        ...
        frame_count += 1
        current_time = frame_count / args.fps  # Current timestamp in seconds
        ...
        for result in results:
            for data in result.boxes.data.tolist():
                ...
                if confidence > args.conf and class_id == 2:
        ...
        mode_text = f"Mode: {args.camera_mode.upper()}"
